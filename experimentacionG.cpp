...
void foo(string line, vector<string> &v, int nconj);
/*-----------------------------------*/

/*Inicializacion de la funcion que lee el documento original*/
vector< vector<string> > lectura(int nlinea, string archivo, int nconj);
/*-----------------------------------*/

/*Inicializacion de funcion que calcula el tiempo de llenado
con los distintos conjuntos seleccionados.*/
void tiempot();
/*-----------------------------------*/


/*Inicializacion de funcion que retorna la estadística de nodos
para cada partición de estos.*/
void tiempoNodoM();
void tiempoNodoU();
void tiempoNodoP();
void tiempoNodoF();
...
/*Inicializacion de funcion que retorna la estadística del
...
/*Inicializacion de funcion que retorna la estadística del
grado máximo y mínimo del grafo*/
void tiempoMax();
void tiempoMin();
/*-----------------------------------*/

/*Inicializacion de funcion que retorna la consulta de
la fecha y usuario con más tweets*/
void tiempoFMT();
void tiempoUMT();
/*-----------------------------------*/

/*Inicializacion de funcion que retorna la consulta de
los usuarios y fechas en que se han dicho una palabra*/
void tiempoUP(string stt);
void tiempoFP(string stt);
/*-----------------------------------*/
...
int main(){
    ...
    int nlinea, nconj, nrepeticiones;
    double tllenado;

//--------------------GUARDAR EN ESTRUCTURAS----------------------------------//

    /*---Llenado sin cálculo de tiempo---*/ /*
    ...
    */ /*-----------------------------------*/
    ...
    /*---Análisis del tiempo de llenado---*/
   	...
   	//Resultados - microseconds - 100 repeticiones
   	//				1000	2000 	3000	4000	5113
   	//conjunto 1 	7887.25 16178.5	23584.2	29634.4	36156.7
   	//conjunto 2 	8588.89	17468.8	24841.2	31519.3	38856.8				
   	//conjunto 3 	11346.9	22284.7	32778.9	40964.8	50889.7
   	/*-----------------------------------*/			
    


    /*---Análisis del tiempo de consulta nodo Mensaje, Usuario, Palabra y Fecha---*/

   	//tiempoNodoM();

   	//Resultados tiempoNodoM - microseconds - 1000 repeticiones
   	//				conjunto 3
   	//Tamaño 500	12.925
   	//Tamaño 2500	13.548
   	//Tamaño 5000	12.124
   	...
   	//Resultados tiempoNodoU - microseconds - 1000 repeticiones
   	//				conjunto 3
   	//Tamaño 500	12.642
   	//Tamaño 2500	12.923
   	//Tamaño 5000	13.398
   	...
   	//Resultados tiempoNodoP - microseconds - 1000 repeticiones
   	//				conjunto 3
   	//Tamaño 500	13.001
   	//Tamaño 2500	13.17
   	//Tamaño 5000	12.153
   	...
   	//Resultados tiempoNodoF - microseconds - 1000 repeticiones
   	//				conjunto 3
   	//Tamaño 500	12.41
   	//Tamaño 2500	12.017
   	//Tamaño 5000	11.796
    ...
    /*---Análisis del tiempo de consulta del número de aristas, grado máximo y mínimo---*/

   	//tiempoArista();

   	//Resultados tiempoArista - microseconds - 1000 repeticiones
   	//				conjunto 3
   	//Tamaño 500	12.183
   	//Tamaño 2500	12.679
   	//Tamaño 5000	11.596
   	...
   	//Resultados tiempoMax - microseconds - 1000 repeticiones
   	//				conjunto 3
   	//Tamaño 500	11.351
   	//Tamaño 2500	12.096
   	//Tamaño 5000	12.695
   	...
   	//Resultados tiempoMin - microseconds - 1000 repeticiones
   	//				conjunto 3
   	//Tamaño 500	15.266
   	//Tamaño 2500	27.103
   	//Tamaño 5000	56.908
    ...
    /*---Análisis del tiempo de consultas particulares---*/

   	//tiempoFMT();

   	//Resultados tiempoFMT - microseconds - 1000 repeticiones
   	//				conjunto 3
   	//Tamaño 500	13.298
   	//Tamaño 2500	16.674
   	//Tamaño 5000	39.767
   	...
   	//Resultados tiempoUMT - microseconds - 1000 repeticiones
   	//				conjunto 3
   	//Tamaño 500	2.115
   	//Tamaño 2500	2.035
   	//Tamaño 5000	2.273
   	...
   	//Resultados tiempoUP - microseconds - 100 repeticiones buscar "google"
   	///				conjunto 3
   	//Tamaño 500	11.684
   	//Tamaño 2500	1285.72
   	//Tamaño 5000	1311.25
   	...
   	//Resultados tiempoFP - microseconds - 100 repeticiones buscar "google"
   	//				conjunto 3
   	//Tamaño 500	5.66
   	//Tamaño 2500	17231.3
   	//Tamaño 5000	18281.1
   	...
   	//Resultados tiempoUP - microseconds - 100 repeticiones
   	//				conjunto 3
   	//Tamaño 500	2.37 (no encontrada)
   	//Tamaño 2500	8.12
   	//Tamaño 5000	117.6

   	//tiempoFP("tecnologia");

   	//Resultados tiempoFP - microseconds - 100 repeticiones
   	//				conjunto 3
   	//Tamaño 500	2.48 (no encontrada)
   	//Tamaño 2500	10.08
   	//Tamaño 5000	142.88

   	//tiempoUP("collaboration");

   	//Resultados tiempoUP - microseconds - 100 repeticiones
   	//				conjunto 3
   	//Tamaño 500	2.55 (no encontrada)
   	//Tamaño 2500	5.45
   	//Tamaño 5000	9.12

   	tiempoFP("collaboration");

   	//Resultados tiempoFP - microseconds - 100 repeticiones
   	//				conjunto 3
   	//Tamaño 500	2.73 (no encontrada)
   	//Tamaño 2500	8.93
   	//Tamaño 5000	11.19
...
/*Función que calcula el tiempo promedio de llenado 
del grafo según el conjunto seleccionado*/
void tiempot(){
	string archivo="dataset-proyecto";
    double tllenado=0.0;
	int nlinea, nrepeticiones, nconj;

    cout<<"Numero de repeticiones, numero de líneas (máximo 5113) y conjunto a usar (1,2,3) ";
    cin>>nrepeticiones>>nlinea>>nconj;
    
    vector< vector<string> > v=lectura(nlinea, archivo,nconj);
    
    for(int k=0; k<nrepeticiones; k++){
    	Grafo G;
	    ...
	    for(int i=0; i<nlinea; i++){
	        ...
	        tllenado+=chrono::duration_cast<chrono::microseconds>(fin-inicio).count(); //seconds-milliseconds-microseconds-nanoseconds
	    }
	}

	cout<<"El tiempo promedio de llenado de la tabla para el conjunto "<<nconj<<" es "<<tllenado/nrepeticiones<<" microseconds"<<endl;
}



/*Función que calcula el tiempo promedio de la consulta:
Número de nodos tipo Mensaje*/
void tiempoNodoM(){
	string archivo="dataset-proyecto";
    double tllenado=0.0;
	int nlinea, nrepeticiones, nconj=3;

    cout<<"Numero de repeticiones y líneas a analizar ";
    cin>>nrepeticiones>>nlinea;
	...
	cout<<"El tiempo promedio de consulta del número de vértices Mensajes es "<<tllenado/nrepeticiones<<" microseconds"<<endl;
}


/*Función que calcula el tiempo promedio de la consulta:
Número de nodos tipo Usuario*/
void tiempoNodoU(){
	string archivo="dataset-proyecto";
    double tllenado=0.0;
	int nlinea, nrepeticiones, nconj=3;
	...
	cout<<"El tiempo promedio de consulta del número de vértices Usuario es "<<tllenado/nrepeticiones<<" microseconds"<<endl;
}


/*Función que calcula el tiempo promedio de la consulta:
Número de nodos tipo Palabra*/
void tiempoNodoP(){
	string archivo="dataset-proyecto";
    double tllenado=0.0;
	int nlinea, nrepeticiones, nconj=3;
	...
	cout<<"El tiempo promedio de consulta del número de vértices Palabra es "<<tllenado/nrepeticiones<<" microseconds"<<endl;
}
...
void tiempoNodoF(){
	...
	cout<<"El tiempo promedio de consulta del número de vértices Fecha es "<<tllenado/nrepeticiones<<" microseconds"<<endl;
}
...
void tiempoArista(){
	...
	cout<<"El tiempo promedio de consulta del número de aristas es "<<tllenado/nrepeticiones<<" microseconds"<<endl;
}
...
void tiempoMax(){
	...
	cout<<"El tiempo promedio de consulta del grado máximo es "<<tllenado/nrepeticiones<<" microseconds"<<endl;
}
...
void tiempoMin(){
	...
	cout<<"El tiempo promedio de consulta del grado mínimo es "<<tllenado/nrepeticiones<<" microseconds"<<endl;
}



/*Función que calcula el tiempo promedio de la consulta:
Fecha con más tweets*/
void tiempoFMT(){
	string archivo="dataset-proyecto";
    double tllenado=0.0;
	int nlinea, nrepeticiones, nconj=3;
	...
	cout<<"El tiempo promedio de consulta es "<<tllenado/nrepeticiones<<" microseconds"<<endl;
}
...
/*Función que calcula el tiempo promedio de la consulta:
Usuarios que han dicho una palabra*/
void tiempoUP(string stt){
	string archivo="dataset-proyecto";
    double tllenado=0.0;
	int nlinea, nrepeticiones, nconj=3;
...
/*Función que calcula el tiempo promedio de la consulta:
Fechas que han dicho una palabra*/
void tiempoFP(string stt){
	string archivo="dataset-proyecto";
    double tllenado=0.0;
	int nlinea, nrepeticiones, nconj=3;
